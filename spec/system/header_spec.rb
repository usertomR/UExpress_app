  ...
  describe ":when you login and click headermenu", js: true do
    it "display appropriate links" do
      ...
      aggregate_failures do
        ...
        expect(page.body).to have_link '気になるリスト'
        expect(page.body).to have_link 'お気に入りの人リスト'
  ...
  describe ":when you  don't login and click headermenu", js: true do
    it "display appropriate links" do
      ...
      aggregate_failures do
        ...
        expect(page.body).not_to have_link '気になるリスト'
        expect(page.body).not_to have_link 'お気に入りの人リスト'
